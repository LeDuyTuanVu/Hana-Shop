<%-- 
    ...
    Created on : Jan 12, 2021, 10:45:03 PM
        ...
        <div class="container-fluid">
            <div class="row" style="margin-left: 1px; margin-right: 1px">
                <div class="col-md-6" style="">
                    <h4 class="mb-3" style="text-transform: uppercase; font-family: 'Patua One', cursive; font-size: 27px; margin-top: 90px">Input information of room you want to create</h4>
                    <form class="needs-validation" novalidate="" style="margin-top: 10px" action="MainController" method="POST">
                        <div class="mb-3">
                            <div class="input-group" style="margin-bottom: 5px"><input type="text" name="txtProductName" class="form-control" id="productName" placeholder="Enter name of product" required="" value="${sessionScope.TXT_CREATE_NAME}"></div>
                            <p style="font-family: monospace; font-size: 15px; color: red; margin-bottom: -7px; margin-left: 1px">${requestScope.MESS_NAME_PRO}</p>
                        </div>
                        <div class="mb-3">
                            <input type="url" name="txtImage" class="form-control" id="image" placeholder="Enter image of product"  style="margin-bottom: 5px" value="${sessionScope.TXT_CREATE_IMAGE}">
                            <p style="font-family: monospace; font-size: 15px; color: red; margin-bottom: -7px; margin-left: 1px">${requestScope.MESS_IMAGE_PRO}</p>
                        </div>
                        <div class="mb-3">
                            <input type="text" name="txtDescription" class="form-control" id="description" placeholder="Enter description of product" required="" style="margin-bottom: 5px" value="${sessionScope.TXT_CREATE_DESCRIPTION}">
                            <p style="font-family: monospace; font-size: 15px; color: red; margin-bottom: -7px; margin-left: 1px">${requestScope.MESS_DES_PRO}</p>
                        </div>
                        <div class="mb-3">
                            <div style="display: flex"><input type="number" step="0.1" name="txtPrice" class="form-control" id="price" placeholder="Enter price of product" required="" style="margin-bottom: 5px" value="${sessionScope.TXT_CREATE_PRICE}"><p style="margin-top: 6.5px; margin-left: 5px">$</p></div>
                            <p style="font-family: monospace; font-size: 15px; color: red; margin-bottom: -7px; margin-left: 1px">${requestScope.MESS_PRICE_PRO}</p>
                        </div>
                        <div class="mb-3">
                            <input type="number" name="txtQuantity" class="form-control" id="quantity" placeholder="Enter quantity of product" required="" style="margin-bottom: 5px;" value="${sessionScope.TXT_CREATE_QUANTITY}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="txtExpiryDate" class="form-control" id="quantity" placeholder="Enter expiry date of product" required="" style="margin-bottom: 5px;" value="${sessionScope.TXT_CREATE_EXPIRY_DATE}">
                        ...
                        <div class="mb-3" style="margin-top: 22px; display: flex">
                            <p style="margin-right: 5px; margin-left: 1px">Type of product</p>
                            <select style="font-family: monospace; border-radius: 4px; height: 27px; font-size: 15px; margin-left: 15px; width: auto" name="comboxCategory">
                                <c:if test="${not empty sessionScope.LIST_CATEGORY_NAME}">
                                    <c:forEach var="categoryName" items="${sessionScope.LIST_CATEGORY_NAME}">
                                        <c:set var="temp" value="${sessionScope.TXT_CREATE_CATEGORY}"></c:set>
                        ...
                        <div class="mb-3" style="display: flex; margin-top: -15px">                          
                            <p style="margin-right: 10px; margin-left: 1px">Status of product</p>
                            <select style="font-family: monospace; border-radius: 4px; height: 27px; font-size: 15px; width: auto;" name="comboxStatus">
                                <c:set var="status" value="${sessionScope.TXT_CREATE_STATUS}"></c:set>
                                <c:set var="active" value="true"></c:set>
                                <c:set var="inactive" value="false"></c:set>
                                ...
                                <c:if test="${!status.equals(active) && !status.equals(inactive)}">
                                    <option selected="selected" value="true">Active</option>
                                    <option value="false">Inactive</option>
                                </c:if>
                            </select>
                            <p style="text-transform: uppercase; font-family: 'Cabin Sketch', cursive; font-size: 27px; color: red; margin-top: -5px"></p>
                                ...
                                <c:if test="${not empty requestScope.MESSAGE_ADD_PRODUCT}">
                                    <p style="color: red; font-family: 'Patua One', cursive; font-size: 25px; margin-top: -20px; margin-bottom: 30px">${requestScope.MESSAGE_ADD_PRODUCT}</p>
                                </c:if>
                        ...
                        <div class="mb-3" style="display: flex; margin-top: -15px">
                            ...
                            <input type="submit" name="btnAction" class="form-control" id="address" required="" style="margin-bottom: 4vh; background-color: #343A40; border-color: hotpink; font-family: 'Patua One', cursive; font-size: 19px; color: hotpink; width: 177px; margin-left: 10px" value="CREATE PRODUCT"> 
                        </div>
                    </form>
                </div>
                <div class="col-md-6" style="margin-top: 97px">
                    <div class="">
                        <form action="MainController" method="POST">
                            <div class="card mb-3 box-shadow" style="border: 2px solid #CCCCCC">
                                <img class="card-img-top" src="${sessionScope.TXT_CREATE_IMAGE}" data-holder-rendered="true" style="height: 526px; width: 100%; display: block;">
                                <div class="card-body" style="font-family: 'Patua One', cursive; margin-top: 15px">
                                    <p class="card-text" style="margin-top: -22px">${sessionScope.TXT_CREATE_NAME}</p>
                                    <p class="card-text" style="margin-top: -10px">Price: ${sessionScope.TXT_CREATE_PRICE} $</p>
                                    <div class="d-flex justify-content-between align-items-center" style="margin-top: -2px">
                                        ...
                                        <small class="text-muted" style="margin-top: 10px; margin-bottom: -11px; margin-right: 2px">${sessionScope.TXT_CREATE_DAY}</small>
                                    </div>
                                </div>
                            </div>
                        </form>
