 ...
 */
@WebServlet(name = "MinusQuantityController", urlPatterns = {"/MinusQuantityController"})
public class MinusQuantityController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at MinusQuantityController: " + e.toString());
        } finally {
